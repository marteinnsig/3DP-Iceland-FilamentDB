...
- **Current runtime-accepted release:** v64.0.4 — TPU Pending-row Validation Fix
- **Live engineering database:** [iskort.is/3dp](https://iskort.is/3dp/)
- **Current development focus:** v64 flexible-material comparative testing is complete; the next coherent milestone awaits owner feedback
