...
- **Current runtime-accepted release:** v64.0.0 — TPU Compression and Shore Measurement Foundation
- **Live engineering database:** [iskort.is/3dp](https://iskort.is/3dp/)
- **Current development focus:** v64 flexible-material testing is complete; the next bounded increment awaits open-feedback review
