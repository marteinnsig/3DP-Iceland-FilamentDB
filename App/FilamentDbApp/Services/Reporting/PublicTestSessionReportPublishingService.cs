...
public sealed class PublicTestSessionReportPublishingService
{
    ...
    {
        "MaterialId", "MaterialName", "FlexibleResults", "Manufacturer", "SummaryStatus", "ResultModules",
        ...
        PublicTestSessionPublicationResult publication)
    {
        ...
        var passed =
            ...
            detailBoundary &&
            publication.Html.Contains("Rigid specimen and result quality", StringComparison.Ordinal) &&
