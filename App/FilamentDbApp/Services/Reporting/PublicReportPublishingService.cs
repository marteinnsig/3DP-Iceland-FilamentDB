...
public sealed class PublicReportPublishingService
{
    ...
    {
        "MaterialID", "MaterialName", "FlexibleResults", "Manufacturer", "ProductLine", "BaseMaterial",
        ...
        PublicReportPublicationResult publication)
    {
        ...
        var publicFieldAllowlistPassed = PublicFieldAllowlist.Count == 47 &&
    ...
    private static string BuildHtml(PublicMaterialEngineeringReportModel model, DateTime generatedAt, string versionLabel, string releaseTitle)
    {
        ...
        return "<!doctype html><html lang=\"en\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\">" +
               ...
               $"<div class=\"cards\"><div class=\"card\"><div class=\"label\">Rigid test coverage</div><div class=\"value\">{Value(model.TestCoverage)}</div></div><div class=\"card\"><div class=\"label\">Engineering axes</div><div class=\"value\">{model.VerifiedEngineeringAxes}/6</div></div><div class=\"card\"><div class=\"label\">Public MSRP</div><div class=\"value\">{msrp}</div></div></div>" +
               ...
               FlexibleReportEvidenceService.RenderHtml(model.FlexibleResults) + "</main></body></html>";
    }
