...
public sealed class DocumentationEngineService
{
    ...
    private static IReadOnlyList<DocumentationSection> BuildSections() => new List<DocumentationSection>
    {
        ...
        S("tpu-compression", "8. Flexible-material testing",
            ...
            "The nominal specimen is a 9 mm diameter x 10 mm initial-height cylinder with 100% rectilinear infill. It is printed on the flat circular base and compressed in the Z direction. Actual measured dimensions, print temperature, extrusion multiplier, other print settings, drying and environmental notes remain part of the saved specimen snapshot; unknown values remain blank.",
            "## Test sequence",
            "1. Bring the platen to first contact before noticeable compression and zero displacement. 2. Lower evenly over approximately 15 seconds to 20% of actual initial height (2.00 mm for exactly 10.00 mm). 3. Hold displacement fixed and start timing. 4. Record force separately at 10 seconds and 30 seconds. 5. Use the first compression of independent specimens for baseline comparison and label repeat cycles separately.",
            "## Primary and supporting results",
            "The primary result is Compression Force at 20% Strain - 30 s hold (N). Compression Force at 20% Strain - 10 s hold (N) is supporting detail. The 30-second point was chosen because force change had slowed during method development, reducing sensitivity to small timing error; this does not claim equilibrium.",
            "FORMULA: Force reduction from 10 s to 30 s (%) = (F10 - F30) / F10 x 100. This describes only that interval, not reduction from an unrecorded initial peak.",
            "## Statistics and range handling",
            "Report independent-specimen n, arithmetic mean, sample standard deviation using n-1, coefficient of variation and observed range for each hold time. Missing values are not zero, and ten specimens are not mandatory for every future test.",
        ...
        S("thermal-deflection", "9. Heat Deflection testing",
            "The governed fixture-specific thermal workflow, result endpoint, method traceability and interpretation boundaries.",
            "## Governed method",
            $"Every accepted result is tied to the immutable method version {ThermalDeflectionMethodContract.Version}. The method records one Celsius result per MaterialID and does not reinterpret historical values when a future method changes.",
            "## Specimen and fixture",
            "The specimen is 127 x 12.7 x 3.2 mm and printed flat. It rests across a 110 mm clear support span under a centered nominal 54 g M20 nut load, approximately 0.530 N. The central bolt does not add specimen load.",
            "## Heating and endpoint",
            "The fixture and specimen are heated in an oven from an ambient start near 25 degrees C. The observed heating ramp is non-linear. The governed endpoint is 2.00 mm mid-span deflection; elapsed time is not converted into a result temperature.",
            "## Temperature capture",
            "The recorded result is the nearby under-specimen BlueDOT probe-indicated fixture temperature beside the central assembly when the endpoint is reached. It is stored and published in degrees C. It is not an internal specimen-temperature measurement.",
            "## Sensor limitation",
            "The BlueDOT probe is identified by thermapen.co.uk and FCC ID 2A167 BlueDot. It has no user calibration option. The workflow must not invent calibration precision, uncertainty or specimen-core temperature from this reading.",
            "## Interpretation",
            "A higher result means the specimen reached the defined fixture deflection at a higher nearby probe temperature within this comparative 3DPIceland workflow. It is not ASTM D648, ISO 75 HDT, a certified material property or a substitute for application-specific thermal validation.",
            "NOTE: Missing Heat Deflection evidence is never inferred."),

        S("statistics", "10. Statistical processing",
        ...
        S("confidence", "11. Confidence and scoring",
        ...
        S("data", "12. Data architecture and calculation governance",
        ...
        S("interpretation", "13. Interpreting published results",
        ...
        S("limitations", "14. Known limitations and uncertainty",
            ...
            "## Thermal fixture and probe boundary",
            "Heat Deflection is a nearby BlueDOT probe-indicated fixture temperature at a defined 2.00 mm endpoint. The oven ramp is non-linear, the probe has no user calibration option and the result is not specimen-core temperature, ASTM D648 or ISO 75 HDT.",
        ...
        S("quality", "15. Quality assurance and operating checklist",
        ...
        S("intelligence-handoffs", "16. Governed Engineering Intelligence handoffs",
        ...
        S("future", "17. Future improvements",
            ...
            "Additional properties such as creep, fatigue, abrasion and chemical resistance may eventually complement the current tensile, impact, stiffness and Heat Deflection framework. Each new property should have its own specimen, calculation, verification and limitation documentation."),

        S("references", "18. References and demonstrations",
        ...
        S("revision", "19. Revision history",
