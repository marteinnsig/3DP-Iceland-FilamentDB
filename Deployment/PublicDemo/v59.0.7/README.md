# 3DPIceland Public Demo Dataset v59.0.7

This package contains a schema-v38 SQLite demo validated for 3DPIceland
Engineering Platform v59.0.7.
...
- `3DPIceland-Public-Demo-v59.0.7.sqlite` - governed schema-v38 demo database.
...
1. Extract `3DPIceland-Public-Demo-v59.0.7.sqlite` from this ZIP.
