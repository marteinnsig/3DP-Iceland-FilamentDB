# 3DPIceland Public Demo Dataset v56.0.6.1
...
v56.0.6.1 adds only the explicit public `PublicDemoDatasetV1` AppMeta marker
required for an installed app to classify the intentional absence of owner
Website publication configuration. It does not change identities,
measurements, relationships or excluded domains.

## Files

- `3DPIceland-Public-Demo-v56.0.6.1.sqlite` - governed schema-v38 demo database.
...
1. Extract `3DPIceland-Public-Demo-v56.0.6.1.sqlite` from this ZIP.
